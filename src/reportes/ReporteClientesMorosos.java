...
public class ReporteClientesMorosos {
	public void crearReporteClientesMorosos() {
		// variables de conexion
		conexionPostgresBD conn = new conexionPostgresBD();
		try {
			// obtenemos el archivo jrxml
			String jrxmlFile = System.getProperty("user.dir") + "\\reporte_de_clientes_morosos.jrxml";
...
//        arg.put("P_DPI", pagosPendientes);
			...
			jv.setTitle("Reporte de clientes morosos");

...
public class ReportePropiedadPorDpi {
	
	/**
	 * Revisa los DPIs ingresados en cada registro para ver si existe o no.
	 * @param dpi Dpi a ser revisado si existe o no.
	 * @return
	 */
	public boolean existeDpi(String dpi) {
		...
		// Armamos la consulta
		String SQL = "SELECT codigo_propiedad FROM propiedad WHERE dpi_cliente = ?";
	...
	/**
	 * Consulta a todos propiedades de acuerdo a los DPIs y los muestra en un reporte.
	 */
	public void crearReportePropiedadPorDpi(List<String> pDpi) {
		//variables de conexion
        conexionPostgresBD conn = new conexionPostgresBD();
        try {
            //obtenemos el archivo jrxml
            String jrxmlFile = System.getProperty("user.dir") + "\\reporte_de_propiedades_por_dpi.jrxml";
            ...
            jv.setTitle("Reporte de Propiedades por Código de propiedad");
